...
<p style="padding-right: 120px; margin-left: -220px;"><img src="imgs/logo.png" width="950" height="950" alt="logo"></p>
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<input type="radio" name="type" value="0"><label>User</label>
			<input type="radio" name="type" value="1"><label>Admin</label>
			<div class="input-group" style="padding-top: 10px;">
				<button name="submit" class="btn">Register</button>
			</div>
			<p class="login-register-text" style="padding-top: 15px;">Have an account? <a href="login.php">Login Here</a>, or go <a href="index.php">Home</a>.</p>
		</form>
	</div>
</body>
</html>